...
2. Advert Start: Look for the explicit sponsor pitch or a break announcement immediately leading into the pitch. If the transcript begins with regular show conversation (e.g. hosts chatting about regular show topics), cut it out. The advert starts at the break transition or commercial pitch.
