...
def ask_phase1_topics(url, model, blocks_subset):
    ...
    sys_msg = (
        ...
        "CRITICAL INSTRUCTION: The topics must be strictly contiguous with no gaps (e.g. 101-110, 111-115, 116-150).\n"
        "CRITICAL INSTRUCTION: Break the transcript into distinct topics based on natural conversation shifts.\n"
        "CRITICAL INSTRUCTION: Identify any promotional content. They are usually short (2-15 blocks) and MUST be placed in their own isolated topics.\n"
        ...
        "Hosts will often signpost a break in the show with phrases like 'let's take a short break', 'a message from our sponsor', 'we'll be right back', or 'after the break'.\n"
        ...
        "Category Definitions:\n"
        "- 'show_content': Primary show conversation, stories, news, interviews, or banter.\n"
        "- 'sponsor_read': Commercial pitches/advertisements for EXTERNAL companies/products/services/charities (e.g. software, B2B, consumer goods, retail stores, food/drink, savings etc.). Classify ALL obvious advertisements for 3rd parties as sponsor_read!\n"
