...
def export():
    ...
    html_content = [
        ...
        "        a { text-decoration: none; color: #0066cc; font-weight: bold; font-size: 1.2em; display: block; }",
        "        a:hover { color: #004499; }",
        "        p.desc { font-size: 0.9em; color: #888; margin-top: 8px; margin-bottom: 0; text-transform: uppercase; letter-spacing: 0.5px; }",
        "    </style>",
        "</head>",
        "<body>",
        "    <h1>My Cleaned Podcasts</h1>",
        "    <p class=\"subtitle\">Copy the RSS feed link and add it to your podcast app.</p>",
        "    <ul>"
    ]
